...
const PLANT_BOSS_ATTACK_RANGE = 280 * BOSS_ACTION_SCALE;
const PLANT_BOSS_SUMMON_DISTANCE_MIN = 80 * BOSS_ACTION_SCALE;
const PLANT_BOSS_SUMMON_DISTANCE_MAX = 150 * BOSS_ACTION_SCALE;
const PLANT_BOSS_MELEE_SUMMON_COUNT = 10;
const PLANT_BOSS_RANGED_SUMMON_COUNT = 5;
const PLANT_BOSS_RETREAT_CHECK_MS = 5000;
const PLANT_BOSS_RETREAT_TRIGGER_DISTANCE = 130 * BOSS_ACTION_SCALE;
const PLANT_BOSS_RETREAT_DISTANCE = 150 * BOSS_ACTION_SCALE;
...
const PLANT_BOSS_BLOCK_EDGE_CHECK_DISTANCE = 44 * BOSS_ACTION_SCALE;
const PLANT_BOSS_BLOCK_EDGE_ESCAPE_DISTANCE = 120 * BOSS_ACTION_SCALE;
...
const PLANT_BOSS_VINE_WIDTH = 18 * BOSS_ACTION_SCALE;
const PLANT_BOSS_VINE_DISPLAY_HEIGHT = 38 * BOSS_ACTION_SCALE;
...
const PLANT_BOSS_VINE_CURVE_SWAY = 28 * BOSS_ACTION_SCALE;
