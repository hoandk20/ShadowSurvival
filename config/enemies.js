...
export const ENEMIES = {
    skeleton: createEnemyConfig({
        ...
        behavior: 'chase',
        texture: 'skeleton',
        displaySize: { width: 28, height: 28 },
    ...
    giant_rock: createEnemyConfig({
        ...
        texture: 'giant_rock',
        displaySize: { width: 90, height: 90 },
        hitboxSize: { width: 123, height: 123 },
        flashTint: 0xffb36b,
        flashDuration: 120,
        isBoss: true,
