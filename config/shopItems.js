...
const createShopItem = ({
    ...
    maxPurchases: Number.isFinite(maxPurchases) ? Math.max(1, Math.floor(maxPurchases)) : null,
...
export const SHOP_ITEM_CONFIG = Object.freeze([
    createShopItem({ id: 'iron_sword', name: 'Iron Sword', type: 'stat', cost: 43, assetPath: 'assets/shopitem/iron_sword.png', modifiers: { damageMultiplier: 0.07, skillRange: -5 } }),
    createShopItem({ id: 'sharpened_blade', name: 'Sharpened Blade', type: 'stat', cost: 43, assetPath: 'assets/shopitem/sharpened_blade.png', modifiers: { critChance: 0.03 } }),
    createShopItem({ id: 'heavy_edge', name: 'Heavy Edge', type: 'stat', cost: 43, assetPath: 'assets/shopitem/heavy_edge.png', modifiers: { critMultiplier: 0.08, skillRange: -5 } }),
    createShopItem({ id: 'quick_gloves', name: 'Quick Gloves', type: 'stat', cost: 45, assetPath: 'assets/shopitem/quick_gloves.png', modifiers: { attackSpeed: 0.08, moveSpeed: -5 } }),
    createShopItem({ id: 'battle_focus', name: 'Battle Focus', type: 'stat', cost: 51, assetPath: 'assets/shopitem/battle_focus.png', modifiers: { damageMultiplier: 0.08, critChance: 0.08, armor: -3 } }),
    createShopItem({ id: 'steel_armor', name: 'Steel Armor', type: 'stat', cost: 42, assetPath: 'assets/shopitem/steel_armor.png', modifiers: { armor: 2, hp: -10 } }),
    createShopItem({
        id: 'ironarmo',
        name: 'Iron Armo',
        type: 'stat',
        ...
        shortText: '+2 armor, but heavy plating reduces move speed by 5.',
        modifiers: { armor: 2, moveSpeed: -5 }
    }),
    createShopItem({
        id: 'icearmo',
        name: 'Ice Armo',
        ...
        shortText: '+3 armor, but the frozen shell reduces attack speed by 15%.',
        modifiers: { armor: 3, attackSpeed: -0.15 }
    }),
    createShopItem({ id: 'vital_ring', name: 'Vital Ring', type: 'stat', cost: 42, assetPath: 'assets/shopitem/vital_ring.png', modifiers: { hp: 20, armor: -1 } }),
    ...
    createShopItem({ id: 'swift_boots', name: 'Swift Boots', type: 'stat', cost: 40, assetPath: 'assets/shopitem/swift_boots.png', modifiers: { moveSpeed: 1, attackSpeed: -0.05 } }),
    ...
    createShopItem({ id: 'glass_cannon', name: 'Glass Cannon', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/glass_cannon.png', modifiers: { damageMultiplier: 0.1, armor: -5 } }),
    ...
    createShopItem({ id: 'sniper_scope', name: 'Sniper Scope', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/sniper_scope.png', modifiers: { critChance: 0.1, attackSpeed: -0.15 } }),
    createShopItem({
        id: 'heavy_core',
        name: 'Heavy Payload',
        type: 'hybrid',
    ...
    createShopItem({ id: 'speed_injector', name: 'Speed Injector', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/speed_injector.png', modifiers: { moveSpeed: 10, damageMultiplier: -0.1 } }),
    createShopItem({ id: 'overgrowth_engine', name: 'Overgrowth Engine', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/overgrowth_engine.png', modifiers: { areaSizeMultiplier: 0.2, attackSpeed: -0.1 } }),
    createShopItem({ id: 'time_distorter', name: 'Time Distorter', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/time_distorter.png', modifiers: { armor: -2, dodge: 0.1 } }),
    createShopItem({ id: 'abyssal_catalyst', name: 'Abyssal Catalyst', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/Abyssal_Catalyst.png', modifiers: { damageMultiplier: 0.8, effectDamageMultiplier: 0.8, healthRegenPerSecond: -1.5 } }),
    createShopItem({ id: 'singularity_field', name: 'Singularity Field', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/Singularity_Field.png', modifiers: { areaSizeMultiplier: 0.5, knockbackMultiplier: 0.5, damageMultiplier: -0.15 } }),
    createShopItem({ id: 'phantom_stride', name: 'Phantom Stride', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/Phantom_Stride.png', modifiers: { moveSpeed: 10, pickupRangeMultiplier: 0.15, armor: -2 } }),
    createShopItem({ id: 'rotheart_sigil', name: 'Rotheart Sigil', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/Rotheart_Sigil.png', modifiers: { effectChance: 0.15, effectDamageMultiplier: 0.1, damageMultiplier: -0.1 } }),
    createShopItem({ id: 'fractured_tempo', name: 'Fractured Tempo', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/Fractured_Tempo.png', modifiers: { attackSpeed: 0.15, damageMultiplier: -0.05, knockbackMultiplier: -0.2 } }),
    createShopItem({ id: 'vampire_pact', name: 'Vampire Pact', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/vampire_pact.png', modifiers: { lifesteal: 0.05, hp: -20 } }),
    createShopItem({ id: 'reckless_core', name: 'Reckless Core', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/reckless_core.png', modifiers: { critMultiplier: 0.15, hp: -15 } }),
    createShopItem({ id: 'impact_engine', name: 'Impact Engine', type: 'hybrid', cost: 50, assetPath: 'assets/shopitem/impact_engine.png', modifiers: { knockbackMultiplier: 0.3, damageMultiplier: 0.05 } }),
    createShopItem({ id: 'toxic_catalyst', name: 'Toxic Catalyst', type: 'effect', cost: 56, assetPath: 'assets/shopitem/toxic_catalyst.png', modifiers: { effectChance: 0.1, effectDamageMultiplier: 0.1, dodge: -0.07 } }),
    createShopItem({ id: 'lingering_curse', name: 'Lingering Curse', type: 'effect', cost: 73, assetPath: 'assets/shopitem/lingering_curse.png', modifiers: { attackSpeed: 0.8, effectDurationMultiplier: 0.8 } }),
    createShopItem({
        id: 'chain_amplifier',
    ...
    createShopItem({
        ...
        shortText: '-20 HP, +10% effect damage, leaves a poison trail behind the player.',
        modifiers: { hp: -20, effectDamageMultiplier: 0.1 },
    ...
    createShopItem({
        ...
        shortText: '+20 HP, -2 armor. Every 1s releases a fire wave in radius 70, dealing damage equal to 15% of the owner max HP and applying burn.',
        modifiers: { hp: 20, armor: -2 },
        maxPurchases: 1,
        special: {
            firecoatAura: {
                intervalMs: 1000,
                radius: 70,
                damageFromOwnerMaxHealthRatio: 0.15
            }
        }
    }),
    createShopItem({ id: 'elemental_overload', name: 'Elemental Overload', type: 'effect', cost: 58, assetPath: 'assets/shopitem/elemental_overload.png', modifiers: { effectChance: 0.1, effectDamageMultiplier: 0.1, damageMultiplier: -0.1 } }),
    createShopItem({
        id: 'shockwave_core',
        name: 'Shockwave Core',
        type: 'effect',
        ...
        effectBonuses: { shock: { chainDamageBonus: 0.05 } },
        availability: { requiresActiveEffect: 'shock' }
    }),
    ...
    createShopItem({
        ...
        availability: { excludesCharacterKeys: ['knight', 'witch'] },
        unlockElement: {
            effectKey: 'explosion',
            label: 'Explosion',
            mode: 'hit_explosion',
    ...
    createShopItem({ id: 'magnet_core', name: 'Magnet Core', type: 'utility', cost: 70, assetPath: 'assets/shopitem/magnet_core.png', modifiers: { pickupRangeMultiplier: 0.15 } }),
    createShopItem({ id: 'golden_idol', name: 'Golden Idol', type: 'utility', cost: 72, assetPath: 'assets/shopitem/golden_idol.png', modifiers: { goldGainMultiplier: 0.1, damageMultiplier: -0.1 } }),
    createShopItem({ id: 'greed_engine', name: 'Greed Engine', type: 'utility', cost: 72, assetPath: 'assets/shopitem/greed_engine.png', modifiers: { goldGainMultiplier: 0.1, hp: -20 } })
]);
...
export function getConditionalShopExcludeIds(activeEffectKeys = [], characterKey = null) {
    ...
    const characterConfig = characterKey ? getCharacterConfig(characterKey) : null;
    const isMeleeCharacter = characterConfig?.combatStyle === 'melee';
    return SHOP_ITEM_CONFIG
        .filter((item) => {
            ...
            if (isMeleeCharacter && item.modifiers) {
                // Projectile-focused items are useless for melee-only characters.
                const hasProjectileModifier = Object.keys(item.modifiers).some((key) => key.startsWith('projectile'));
                if (hasProjectileModifier) return true;
            }
            return false;
        })
        .map((item) => item.id);
