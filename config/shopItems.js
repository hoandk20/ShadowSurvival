...
export const SHOP_ITEM_CONFIG = Object.freeze([
    ...
    createShopItem({ id: 'speed_injector', name: 'Speed Injector', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/speed_injector.png', modifiers: { moveSpeed: 20, damageMultiplier: -0.15 } }),
    ...
    createShopItem({ id: 'abyssal_catalyst', name: 'Abyssal Catalyst', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/Abyssal_Catalyst.png', modifiers: { damageMultiplier: 0.35, effectDamageMultiplier: 0.25, healthRegenPerSecond: -4 } }),
    ...
    createShopItem({ id: 'rotheart_sigil', name: 'Rotheart Sigil', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/Rotheart_Sigil.png', modifiers: { effectChance: 0.25, effectDamageMultiplier: 0.3, damageMultiplier: -0.2 } }),
    ...
    createShopItem({ id: 'vampire_pact', name: 'Vampire Pact', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/vampire_pact.png', modifiers: { lifesteal: 0.1, hp: -50 } }),
    createShopItem({ id: 'reckless_core', name: 'Reckless Core', type: 'hybrid', cost: 40, assetPath: 'assets/shopitem/reckless_core.png', modifiers: { critMultiplier: 0.2, hp: -15 } }),
    ...
    createShopItem({
        ...
        special: {
            firecoatAura: {
                intervalMs: 1000,
                radius: 70,
                damageFromOwnerMaxHealthRatio: 0.2
            }
        }
    }),
